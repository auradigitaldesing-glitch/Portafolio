...
const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      '/images/01-04.jpg',
      '/images/01-05.jpg',
      '/images/rxlab-linkedin-02.png',
      '/images/rxlab-post-1.png',
      '/images/rxlab-post-05.png',
      '/images/rxlab-post-06.png',
      '/images/rxlab-02-02.png',
      '/images/2.jpg',
      '/images/3.jpg',
...
function MediaCarousel({ items, title }: { items: MediaItem[]; title: string }) {
  ...
  return (
    <div className="relative w-full">
      ...
      <button
        onClick={() => paginate(-1)}
        className="absolute left-2 top-1/2 -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-black/50 backdrop-blur-sm text-white/70 hover:text-white hover:bg-black/70 transition-all"
        aria-label="Anterior"
      >
      ...
      <button
        onClick={() => paginate(1)}
        className="absolute right-2 top-1/2 -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-black/50 backdrop-blur-sm text-white/70 hover:text-white hover:bg-black/70 transition-all"
...
function ProjectWithCarousel({ project, index }: { project: Project; index: number }) {
  const itemRef = useRef<HTMLDivElement>(null)
  const { scrollYProgress } = useScroll({
    target: itemRef,
    offset: ["start end", "end start"]
...
function ProjectItem({ project, index }: { project: Project; index: number }) {
  ...
  // Si tiene imágenes, usar el componente especial con grid
  if (project.images) {
